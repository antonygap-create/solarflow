...
Author: Senior Python/FastAPI Developer & Database Architect
...
class Tenant(Base):
    ...
    # Default commercial settings for installer proposal generation
...
class Project(Base):
    ...
    def __repr__(self) -> str:
        return f"<Project(name='{self.name}', address='{self.address[:30]}...')>"
